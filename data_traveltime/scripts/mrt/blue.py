...
# station_route = "../../../station_route/data/mrt/mrt_b_route.csv"
...
# train_time1 = pd.to_datetime("23:11:00", format="%H:%M:%S")
# train_data1 = []
...
#     [time_travel.iloc[:6878], pd.DataFrame(train_data1)], ignore_index=True
# )
...
# time_travel.to_csv("b_go.csv", index=False)
...
time_travel = pd.concat([time_travel.iloc[:7030]], ignore_index=True)
...
time_travel.to_csv("b_back.csv", index=False)
