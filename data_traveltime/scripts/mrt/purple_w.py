...
#     [time_travel.iloc[:1680], pd.DataFrame(train_data1)], ignore_index=True
# )
time_travel = pd.concat([time_travel.iloc[:1755]], ignore_index=True) 
...
time_travel.to_csv("p_w_back.csv", index=False)
