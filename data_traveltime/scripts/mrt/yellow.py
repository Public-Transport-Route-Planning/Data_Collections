...
# station_route = "../../../station_route/data/mrt/mrt_y_route.csv"
...
#     [time_travel.iloc[:3102], pd.DataFrame(train_data1)], ignore_index=True
# )
...
# route_weekend = pd.read_csv("y_w_go.csv")

# time_travel = pd.concat([time_travel, route_weekend], axis=0)
# time_travel.to_csv("y_go.csv", index=False)
...
route_weekend = pd.read_csv("y_w_back.csv")

time_travel = pd.concat([time_travel, route_weekend], axis=0)
time_travel.to_csv("y_back.csv", index=False)
