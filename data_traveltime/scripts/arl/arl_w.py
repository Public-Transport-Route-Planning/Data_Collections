...
travel_times = [5, 5, 4, 4, 5, 3, 2]  
# travel_times = [2, 3, 5, 4, 4, 5, 5]
...
time_travel = pd.concat(
    [time_travel.iloc[:651], pd.DataFrame(train_data1)], ignore_index=True
)
...
time_travel.to_csv("arl_w_go.csv", index=False)
# output_directory = "../../data/arl"
# output_filename = "arl_w_go.csv"  # html,csv
