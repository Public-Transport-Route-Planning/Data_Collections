...
#     [time_travel.iloc[:9706], pd.DataFrame(train_data1)], ignore_index=True
# )
...
# route_weekend = pd.read_csv("su_w_go.csv")


# time_travel = pd.concat([time_travel, route_weekend], axis=0)
# time_travel.to_csv("su_go.csv", index=False)
...
route_weekend = pd.read_csv("su_w_back.csv")
time_travel = pd.concat([time_travel, route_weekend], axis=0)
time_travel.to_csv("su_back.csv", index=False)
