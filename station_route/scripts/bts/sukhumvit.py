...
station_data_path = "../../../bts_station/data/bts/sukhumvit_line_station.csv"
...
output_directory = "../../data/bts"
output_filename = "sukhumvit_route.csv"  # html,csv
