...
station_data_path = "../../../bts_station/data/airportlink/airport_line_station.csv"
...
output_directory = "../../data/airportlink"
output_filename = "airportlink_route.csv"  # html,csv
