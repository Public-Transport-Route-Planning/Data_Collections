...
station_data_path = "../../../bts_station/data/mrt/blue_line_station.csv"

station_data = pd.read_csv(station_data_path)

stations = station_data[["sid", "name_e", "lat", "lon"]].values.tolist()
insert = ["BL01", "Tha Phra", 13.729653, 100.474163]
stations.insert(32, insert)
# print(stations)
...
output_filename = "blue_route.csv"  # html,csv
